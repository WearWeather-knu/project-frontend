...
const tabs = [
  { to: '/closet', label: 'closet', logo: <ClosetLogo /> },
  { to: '/', label: '홈', end: true, logo: <MainLogo /> },
  { to: '/profile', label: 'profile', logo: <ProfileLogo /> },
];
...
function MainLogo({ color = 'currentColor' }) {
  return (
    <svg
      width="85"
      height="85"
    ...
    >
      <g filter="url(#filter0_d_85_518)">
        <circle cx="38.5" cy="38.5" r="35.5" fill={color} />
      </g>
      <path
